...
// Klicka på videorutan för att starta/pausa videon
video_player.addEventListener("click", () => {
  const isVideoPaused = video_player.classList.contains("paused");
  isVideoPaused ? pauseVideo() : playVideo();
});

// Klicka på play-knappen för att starta/pausa videon
play_pause.addEventListener("click", (event) => {
  // Stoppar vidare propagation för att undvika att videon pausas/startas flera gånger
