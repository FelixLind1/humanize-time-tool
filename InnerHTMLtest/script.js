...
function sparaText() {
    ...
    if (userInput.trim() === "") {
        ...
        fetch('http://192.168.1.100:3003/save', {  // Ändrad till IP-adress
            method: 'POST',
            headers: {
...
function laddaText() {
    fetch('http://192.168.1.100:3003/load', {  // Ändrad till IP-adress
        method: 'GET',
    })
...
function tabortText() {
    ...
    fetch('http://192.168.1.100:3003/delete', {  // Ändrad till IP-adress
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
        },
